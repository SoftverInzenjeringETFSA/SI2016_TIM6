...
CREATE TABLE `ispit` (
  ...
  `broj_prijava` int(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_slovenian_ci;
...
INSERT INTO `ispit` (`id`, `prijave_do`, `termin`, `predmet_id`,`kapacitet`,`broj_prijava`) VALUES
(1, '2017-06-17 00:00:00', '2017-06-24 12:00:00', 1,10,0),
(2, '2017-05-30 00:00:00', '2017-05-31 10:00:00', 2,10,1),
(3, '2017-06-28 00:00:00', '2017-06-30 09:00:00', 2,10,1),
(4, '2017-04-10 00:00:00', '2017-04-20 15:00:00', 4,10,2),
(5, '2017-07-07 00:00:00', '2017-07-10 15:00:00', 6,10,1),
(6, '2017-06-14 00:00:00', '2017-06-17 12:00:00', 7,10,0),
(7, '2017-06-01 00:00:00', '2017-06-10 15:00:00', 9,10,1),
(8, '2017-07-02 00:00:00', '2017-07-05 13:00:00', 9,10,3),
(9, '2017-06-10 00:00:00', '2017-06-13 09:00:00', 10,10,3),
(10, '2017-06-08 00:00:00', '2017-06-10 12:00:00', 13,10,1),
(11, '2017-06-23 00:00:00', '2017-06-25 09:00:00', 13,10,0),
(12, '2017-07-10 00:00:00', '2017-07-12 09:00:00', 14,10,0),
(13, '2017-06-04 00:00:00', '2017-06-11 15:00:00', 15,10,0),
(14, '2017-06-13 00:00:00', '2017-06-20 10:00:00', 16,10,0),
(15, '2017-07-11 00:00:00', '2017-07-18 10:00:00', 18,10,0),
(16, '2017-05-28 00:00:00', '2017-05-30 09:00:00', 19,10,0),
(17, '2017-05-24 00:00:00', '2017-05-31 12:00:00', 20,10,0),
(18, '2017-06-28 00:00:00', '2017-06-30 13:00:00', 20,10,0);
...
CREATE TABLE `predmet` (
  ...
  `opis` varchar(256) COLLATE utf8_slovenian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_slovenian_ci;
...
INSERT INTO `predmet` (`id`, `naziv`, `semestar`, `profesor_id`, `odsjek_id`,`opis`) VALUES
(1, 'Inženjerska fizika 1', 1, 4, 1, 'Predmet na prvom semestru'),
(2, 'Inženjerska matematika 1', 1, 1, 1, 'Predmet na prvom semestru'),
(3, 'Osnove elektrotehnike', 1, 3, 1, 'Predmet na prvom semestru'),
(4, 'Tehnike programiranja', 2, 6, 1, 'Predmet na drugom semestru'),
(5, 'Operativni sistemi', 2, 5, 1, 'Predmet na drugom semestru'),
(6, 'Inženjerska matematika 2', 2, 1, 1, 'Predmet na drugom semestru'),
(7, 'Diskretna matematika', 3, 6, 1, 'Predmet na trećem semestru'),
(8, 'Računarske arhitekture', 4, 2, 1, 'Predmet na četvrtom semestru'),
(9, 'Operativni sistemi', 2, 5, 1, 'Predmet na drugom semestru'),
(10, 'Vjerovatnoća i statistika', 2, 10, 1, 'Predmet na drugom semestru'),
(11, 'Matematička logika i teorija izračunljivosti', 2, 6, 1, 'Predmet na drugom semestru'),
(12, 'Elektronički elementi ', 2, 9, 2, 'Predmet na drugom semestru'),
(13, 'Električni krugovi 1', 2, 3, 2, 'Predmet na drugom semestru'),
(14, 'Inženjerska fizika 2', 2, 4, 2, 'Predmet na drugom semestru'),
(15, 'Tehnike programiranja', 2, 6, 2, 'Predmet na drugom semestru'),
(16, 'Linearni sistemi automatskog upravljanja', 4, 27, 2, 'Test'),
(17, 'Aktuatori', 1, 26, 2, 'Test'),
(18, 'Računarsko modeliranje i simulacija', 1, 5, 1, 'Test'),
(19, 'Osnove računarstva', 1, 8, 2, 'Test'),
(20, 'Digitalni sistemi upravljanja', 1, 1, 2, 'Test'),
(21, 'Osnove elektrotehnike', 1, 3, 2, 'Test'),
(22, 'Linearna algebra i geometrija', 1, 7, 1, 'Test'),
(23, 'Robotika 1', 1, 26, 2, 'Test'),
(24, 'Osnove baza podataka', 3, 16, 1, 'Test'),
(25, 'Razvoj programskih rješenja', 3, 12, 1, 'Test'),
(26, 'Numerički algoritmi', 3, 6, 1, 'Test'),
(27, 'Sistemsko programiranje', 3, 5, 1, 'Test'),
(28, 'Algoritmi i strukture podataka', 3, 11, 1, 'Test'),
(29, 'Logički dizajn', 3, 2, 1, 'Test'),
(30, 'Automati i formalni jezici', 4, 11, 1, 'Test'),
(31, 'Objektno orijentisana analiza', 4, 12, 1, 'Test'),
(32, 'Razvoj mobilnih aplikacija', 4, 14, 1, 'Test'),
(33, 'Osnove računarskih mreža', 4, 15, 1, 'Test'),
(34, 'Ugradbeni sistemi', 4, 13, 1, 'Test'),
(35, 'Komunikacijske tehnologije', 1, 9, 17, 'Test'),
(36, 'Anatomija čovjeka 1', 3, 24, 33, 'Test'),
(37, 'Histologija 1', 1, 25, 33, 'Test'),
(38, 'Fiziologija', 3, 24, 33, 'Test'),
(39, 'Klasična mehanika 1', 3, 17, 22, 'Test'),
(40, 'Matematička analiza 1', 1, 23, 22, 'Test'),
(41, 'Matematička analiza 2', 2, 23, 22, 'Test'),
(42, 'Matematičke metode fizike 1', 3, 18, 22, 'Test'),
(43, 'Matematičke metode fizike 2', 4, 18, 22, 'Test'),
(44, 'Matematičke metode fizike 3', 5, 18, 22, 'Test'),
(45, 'Elektromagnetizam', 3, 19, 22, 'Test'),
(46, 'Optika', 4, 19, 22, 'Test'),
(47, 'Atomska fizika', 4, 19, 22, 'Test'),
(48, 'Opća hemija za fizičare', 2, 20, 22, 'Test'),
(49, 'Teorija elektromagnetnog polja', 5, 18, 22, 'Test'),
(50, 'Kvantna mehanika 1', 5, 21, 22, 'Test'),
(51, 'Kvantna mehanika 2', 6, 21, 22, 'Test'),
(52, 'Specijalna teorija relativnosti', 5, 22, 22, 'Test'),
(53, 'Digitalni integrirani krugovi', 5, 26, 2, 'Test'),
(54, 'Nelinearni sistemi automatskog upravljanja', 7, 27, 2, 'Test'),
(55, 'Inženjerska matematika 3', 3, 29, 2, 'Test'),
(56, 'Senzori i mjerenja', 3, 26, 2, 'Test');
...
(1, 'Mehmed', 'Baždarević', 'mbazdarevic@etf.unsa.ba', 'm', 'mesa1', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '2810995180046', '1995-10-28', 'Višegrad', 2, 1, 'Zvornicka bb', '033256322'),
(2, 'Silvana', 'Armenulić', 'sarmenulic@etf.unsa.ba', 'ž', 'silvana2', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '1805994232245', '1994-05-18', 'Doboj', 3, 1, 'Pofalićka 2', '033568984'),
(3, 'Nihad', 'Alibegović', 'nalibegovic@etf.unsa.ba', 'm', 'nihad1', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '0101996116432', '1995-01-01', 'Gornji Vakuf', 2, 2, 'Sutjeska 23', '035332312'),
(4, 'Enes', 'Babić', 'enes.predator@gmail.com', 'm', 'enes.babic', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '1006996190058', '1996-06-10', 'Zenica', 3, 33, 'Lukovo polje 12', '062225883'),
(5, 'Nermedin', 'Džeković', 'nermedindz@gmail.com', 'm', 'nermedin.dzekovic', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '1205997190658', '1997-05-12', 'Sarajevo', 2, 13, 'Hrasnička 120', '061584753'),
(6, 'Nudžeim', 'Selimović', 'nudzeims@hotmail.com', 'm', 'nudzeim.selimovic', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '0811995190065', '1995-11-08', 'Sarajevo', 5, 15, 'Adema Buće 15', '062847596'),
(7, 'Senad', 'Isaković', 'isakovics@gmail.com', 'm', 'senad.isakovic', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '2207994190008', '1994-07-22', 'Tuzla', 5, 11, 'Mala aleja 12', '061358742'),
(8, 'Emir', 'Baručija', 'emir.barucija@gmail.com', 'm', 'emir.barucija', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '1109995190066', '1995-09-11', 'Zenica', 6, 1, 'Travnička cesta 36', '062554128'),
(9, 'Šeila', 'Bećirović', 'seila.becirovic@gmail.com', 'ž', 'seila.becirovic', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '0401995100015', '1995-01-04', 'Sarajevo', 6, 7, 'Adresa 345', '062358452'),
(10, 'Jasmina', 'Bajramović', 'jasmina.bajramovic@gmail.com', 'ž', 'jasmina.bajramovic', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '0805995100033', '1995-05-08', 'Zavidovići', 6, 6, 'Adresa 321', '061123123'),
(11, 'Edin', 'Begić', 'edin.begic@gmail.com', 'm', 'edin.begic', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '1405994190056', '1994-05-14', 'Sarajevo', 6, 5, 'Dolac Malta 15', '061874458'),
(12, 'Ervin', 'Beus', 'ervin.beus@gmail.com', 'm', 'ervin.beus', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '0105993190012', '1993-05-01', 'Kakanj', 6, 3, 'Čengić vila 12', '066985214'),
(13, 'Nejra', 'Bahtić', 'nejra.bahtic@gmail.com', 'ž', 'nejra.bahtic', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '0808994100135', '1994-08-08', 'Zenica', 4, 9, 'Pofalićka 33', '062458745'),
(14, 'Emir', 'Bećirović', 'emir.doktor@gmail.com', 'm', 'doktor', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '0108995190054', '1995-08-01', 'Sarajevo', 6, 8, 'Trg solidarnosti 16', '062632854'),
(15, 'Zerina', 'Turković', 'emir.doktor@gmail.com', 'ž', 'zerina.turkovic', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '1204995100013', '1995-04-12', 'Sarajevo', 4, 8, 'Branilaca Dobrinje 13', '061225874');
